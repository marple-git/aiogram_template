...
from sqlalchemy.orm import sessionmaker, Session, joinedload  # noqa
from sqlalchemy.sql import ClauseElement
from sqlalchemy.sql.elements import BinaryExpression

from tgbot.infrastructure.database.models import DatabaseModel
...
class DatabaseContext(Generic[SQLAlchemyModel]):
    ...
    async def get_one(self, *clauses: ExpressionType, load: Optional[Any] = None
